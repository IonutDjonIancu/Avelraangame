...
public class ItemsLore
{
    ...
    public static class Categories
    {
        ...
        public static readonly Dictionary<string, Dictionary<string, string>> Protections = new()
        {
            ...
            { Subtypes.Protections.Helmet, ItemsLore.Protections.Helmets },
    ...
    public static class Protections
    {
        ...
        public static readonly Dictionary<string, string> Helmets = new()
        {
            // danarian
            { "Norse helm"      , "The construction of this helmet is complex. It consists of four parts: an iron skull cap with brass edging and decorations, two iron cheek guards with brass edging, and camail protecting the neck. The cap of the helmet has eight iron components. A brow band encircles the head; a nose-to-nape band extends from back to front, where it narrows and continues downwards as the nasal; two lateral bands each connect the side of the brow band to the top of the nose-to-nape band; and four subtriangular infill plates sit underneath the resulting holes. The eight pieces are riveted together. A usual sight on the battlefield of the northern Dragonmaw continent." },
            { "Bascinet"        , "An open-faced combat helmet. It evolved from a type of iron or steel skullcap, but had a more pointed apex to the skull, and it extended downwards at the rear and sides to afford protection for the neck. A mail curtain (aventail or camail) is usually attached to the lower edge of the helmet to protect the neck and shoulders." },
            { "Armet"           , "A fully enclosed helmet, and narrowed to follow the contours of the neck and throat, it has to have a mechanical means of opening and closing to enable it to be worn. The typical armet consists of four pieces: the skull, the two large hinged cheek-pieces which locked at the front over the chin, and a visor which had a double pivot, one either side of the skull. The cheek-pieces open laterally by means of horizontal hinges; when closed they overlapped at the chin, fastening by a spring-pin which engaged in a corresponding hole, or by a swivel-hook and pierced staple. A reinforcement for the bottom half of the face, known as a wrapper, is sometimes added; its straps were protected by a metal disc at the base of the skull piece called a rondel. The visor is attached to each pivot via hinges with removable pins. Finally, a small aventail, a piece of mail, is attached to the bottom edge of each cheek-piece." },
            { "Barbute"         , "A visorless war helmet often with a distinctive T shaped or Y shaped opening for the eyes and mouth. Barbutes are most commonly raised from a single sheet of metal, and are essentially of iron faced with steel, which is annealed and quenched to give it the desired characteristics of a hard outer surface, with a ductile inner layer which prevented shattering. Many barbutes feature a low front-to-back ridge, raised from the top of the helmet's skull; this serves to strengthen the helmet without adding a significant amount of weight." },
            { "Skull cap"       , "Cheap and easy to produce and thus much used by commoners and non-professional soldiers who could not afford more advanced protection, the skull cap is a round helmet worn above the ears and offers minimal protection for the head." },
            { "Sallet"          , "A round-skulled helmet with a distinctive rear part curved into a flange to protect the neck. It has a short tail and a jawbone type visor with a brow reinforcing. Stylistically, it is termed a high crowned helmet. A plume holder was added to the helmet at some time after its manufacture. These types of helmets are considered both rare and important, therefore only high-born members of the society wear them in combat." },
            { "Great helm"      , "In its simplest form, the great helm is a flat-topped cylinder, usually made of metal, that completely covers the head and has only very small openings for ventilation and vision. Some Danarian makers employ more of a curved design, particularly on the top, to deflect or lessen the impact of blows. The helmet is also extended downward until it reached shoulders." },
            { "Kettle hat"      , "A type of helmet usually made of iron or steel in the shape of a brimmed hat. Of a simple design requiring less time and skill to produce than some other helmet types, it is relatively inexpensive. It is worn most commonly by infantry, and is common all over the Southern parts of the Dragonmaw continent." },
            { "Nasal helm"      , "A helmet characterised by the possession of a nose-guard, or nasal, composed of a single strip of metal that extended down from the skull or browband over the nose to provide facial protection." },
            { "Spangenhelm"     , "Spangen refers to the metal strips that form the framework for the helmet and could be translated as braces. The strips connect three to six steel or bronze plates. The frame takes a conical design that curves with the shape of the head and culminates in a point. The front of the helmet may include a nose protector (a nasal). Older spangenhelms often include cheek flaps made from metal or leather. Spangenhelms may incorporate mail as neck protection, thus forming a partial aventail. Some spangenhelms include eye protection in a shape that resembles modern eyeglass frames. Other spangenhelms include a full face mask, as is ubiquitous with the Paladins of Seracleea." },

            // calvinian
            { "Korintos helmet" , "A helmet that covers the entire head and neck, with slits for the eyes and mouth. A large curved projection protected the nape of the neck. This helmet is massively used by the soldiers of Three Seas dynasties." },
            { "Katabuto"        , "Is a traditional helmet worn by the people of the Stormwatch Mts. It is made by combining dozens of thin iron plates, has a conical shape and is largely covered in decorations." },
            { "Lamellar helmet" , "A helment formed by caps made from overlapping lamellar scales, in addition to a brow plate and nose guard, cheek guards, and camail. It has a conical shape and plumes at the top, as is the eastern custom." },
        };
