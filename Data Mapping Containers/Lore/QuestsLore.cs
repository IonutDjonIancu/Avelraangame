...
public static class QuestsLore
{
    public static readonly Quest Mudpaddler_of_Belford = new()
    {
        ...
        "Clad in a chainmail hauberk, adorned with a surcoat displaying their lord's coat of arms, and wearing a helmet that conceals their face save for the visor, they exude an aura of authority and experience. " +
        ...
        "A patrol needs to be sent south towards Pel'Ravan's forests. It's a three day journey to reach all outposts and report back. Gather supplies and depart with the first light."
    };
