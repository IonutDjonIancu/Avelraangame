...
public interface ICharacterSheetLogic
{
    void SetCharacterSheet(int statPoints, int skillPoints, Character character);
}

public class CharacterSheetLogic : ICharacterSheetLogic
{
    private readonly IDiceLogicDelegator dice;

    public CharacterSheetLogic(IDiceLogicDelegator dice)
    {
        this.dice = dice;
    }

    public void SetCharacterSheet(int statPoints, int skillPoints, Character character)
    {
